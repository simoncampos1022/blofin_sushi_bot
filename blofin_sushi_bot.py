...
WEBHOOK_URL = "https://api.primeautomation.ai/webhook/ChartPrime/ac0ae4a0-ae0d-41fa-9082-674c2468928a"

SUSHIUSDT_SYMBOL = "SUSHIUSDT"
PRODUCT_TYPE = "USDT-FUTURES"
CSV_FILE = "sushi_blofin_history.csv"
    ...
    def get_current_price(self):
        try:
            ...
            for ticker in data['data']:
                if ticker['symbol'] == SUSHIUSDT_SYMBOL:
